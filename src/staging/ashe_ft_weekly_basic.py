"""staging/ashe_ft_weekly_basic.py"""
...
hash = "23ece7a698a9339fe46d370791d8da3493511962ecfec1f487224f6d922d6b78"
schema = schema.Fact
metric_group = "Weekly FT basic pay"
sheet_metric = {
    "Median": {
        "metric": "Median",
        "code": "weekly_ft_basic_pay_med",
        "unit": "GBP (£)",
    },
    "25 percentile": {
        "metric": "Lower quartile",
        "code": "weekly_ft_basic_pay_q25",
        "unit": "GBP (£)",
    },
    "75 percentile": {
        "metric": "Upper quartile",
        "code": "weekly_ft_basic_pay_q75",
        "unit": "GBP (£)",
    },
}
